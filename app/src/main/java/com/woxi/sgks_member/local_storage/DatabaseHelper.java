...
//    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_MEMBER_DETAILS_TABLE_QUERY = "CREATE TABLE " + TABLE_MEMBER_DETAILS + " (" + COLUMN_MEMBER_ID_PRIMARY + " VARCHAR(500) PRIMARY KEY, " + COLUMN_MEMBER_FAMILY_ID_FOREIGN_KEY + " INTEGER, " + COLUMN_MEMBER_SGKS_MEMBER_ID
